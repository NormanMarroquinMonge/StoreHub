console.log("Total Price: ", totalPrice);
            paypal.Buttons({
              createOrder: function(data, actions) {
                return fetch("/COSC640 Project/MYSQL-Version/self-checkout/updateprice.php") // Fetch latest total
            ...
            onApprove: function(data, actions) {
              ...
              fetch('/COSC640 Project/MYSQL-Version/self-checkout/save_transaction.php', {
                  method: 'POST',
                  headers: {
